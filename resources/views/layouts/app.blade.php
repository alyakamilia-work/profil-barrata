...
<head>
  ...
  <title>@yield('title', 'Solusi Teknologi Inovatif') - PT Barrata Global Technology</title>
  <meta name="description" content="@yield('description', 'PT Barrata Global Technology menyediakan layanan IT terintegrasi mulai dari pengembangan perangkat lunak hingga infrastruktur jaringan yang andal.')">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('home') }}" class="logo d-flex align-items-center me-auto me-xl-0">
            <img src="{{ asset('assets/img/logo magang.png') }}" alt="PT Barrata Global Technology Logo">
          </a>
          ...
          <nav id="navmenu" class="navmenu">
            <ul>
                ...
                <li><a href="{{ route('portfolio') }}">Dokumentasi</a></li> 
